...
.setDescription(`Reklam engel sistemini açmak için ${ayarlar.prefix}**reklam-engel aç #kanal** veya ${ayarlar.prefix}**reklam-engel aç** yazmalısın! <a:nlemm:842300606815535115>`)
.setColor('RED')
...
const embed = new Discord.MessageEmbed()
.setDescription(`Reklam engel sistemi başarıyla aktif edildi! <a:on:838420767371821096> `)
.setColor('GREEN')
return message.channel.send(embed)
}
