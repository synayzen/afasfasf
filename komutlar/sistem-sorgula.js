...
exports.run = async(client, message, args) => {
   if (!message.member.hasPermission("ADMINISTRATOR")) return message.reply('| Üzgünüm Bu Komutu Kullana Bilmen İçin `Yönetici` Yetkisine Sahip Olmalısın! <a:nlemm:842300606815535115>')
