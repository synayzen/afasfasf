...
exports.run = async (client ,message, args) =>{
  if (!message.member.permissions.has("ADMINISTRATOR")) return message.channel.send(`Bu Komutu kullanabilmek için yeterli yetkiye sahip değilsin! <a:nlemm:842300606815535115>`)
...
return
  ...
  message.channel.send('Lütfen **aç** veya **kapat** yazın. Örnek Kullanım: **koruma aç/kapat <a:nlemm:842300606815535115>**')
};
exports.conf = {
 enabled: true,
 guildOnly: false,
